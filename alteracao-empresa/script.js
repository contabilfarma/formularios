...
async function enviarDados() {
  ...
  let saudacao =
    horaAtual < 13 ? 'Bom dia!' : horaAtual < 19 ? 'Boa tarde!' : 'Boa noite!';
  ...
  const scriptAPI =
    'https://script.google.com/macros/s/AKfycbyljXOrgt3_TcHgOCdRbGXKOXt1QsgfEdBpH2COXN7kBkP7yo568Q7ZsMzRurw4QwcBww/exec';
