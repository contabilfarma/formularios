...
function enviarDados() {
  ...
  const nomeEmpresa = document
    .getElementById('razao-social')
    .value.toUpperCase();
  const cnpjEmpresa = document.getElementById('cnpj').value;
  const responsavelEmpresa = document
    .getElementById('responsavel-legal')
    .value.toUpperCase();
  const regimeTributario = document
    .getElementById('regime-tributario')
    .value.toUpperCase();
  const dataObrigacoes = document.getElementById('date').value;
  const certificadoDigital = document
    .querySelector("input[type='radio'].certificado:checked")
    .value.toUpperCase();
  const constituida = document
    .querySelector("input[type='radio'].constituida:checked")
    .value.toUpperCase();
  const grupos = document
    .querySelector("input[type='radio'].grupos:checked")
    .value.toUpperCase();
  ...
  const responsavelInterno = document
    .getElementById('interno')
    .value.toUpperCase();
  const responsavelProcesso = document
    .getElementById('responsavel-processo')
    .value.toUpperCase();
  const responsavelComercial = document
    .getElementById('comercial')
    .value.toUpperCase();
  const contadorResponsavel = document
  ...
  if (
    ...
    nomeEmpresa.trim() === '' ||
    cnpjEmpresa.trim() === '' ||
    responsavelEmpresa.trim() === '' ||
    regimeTributario.trim() === '' ||
    data.trim() === '' ||
    telefoneContato.trim() === '' ||
    emailCliente.trim() === '' ||
    responsavelInterno.trim() === '' ||
    responsavelProcesso.trim() === '' ||
    responsavelComercial.trim() === '' ||
    contadorResponsavel.trim() === '' ||
    (grupos === 'SIM' && qualGrupo === '')
  ) {
